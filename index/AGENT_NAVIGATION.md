...
| Add/modify an event type | `schemas/json/` | `src/crucible/events/`, update `index/EVENT_INDEX.yaml` |
| Change simulation behavior | `src/crucible/simulation/` | `make replay-check` after every change |
